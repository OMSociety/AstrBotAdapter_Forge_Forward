...
public class PluginConfig {
    ...
    // 群友绑定配置（QQ ↔ 游戏 ID → 白名单）
    // 默认关闭：绑定会写服务器白名单，属安全敏感操作，必须显式开启。
    private boolean bindingEnabled = false;
    private boolean bindingApplyToWhitelist = true;
    private String bindingStorageFile = "bindings.json";
    // Geyser/Floodgate 兼容：基岩版玩家名默认带前缀（Floodgate use-prefix=true 时是 "."）
    private boolean geyserEnabled = true;
    private String geyserPrefix = ".";
    private boolean geyserUsePrefix = true;
    ...
    public boolean isBindingApplyToWhitelist() {
        return bindingApplyToWhitelist;
    }

    public void setBindingApplyToWhitelist(boolean bindingApplyToWhitelist) {
        this.bindingApplyToWhitelist = bindingApplyToWhitelist;
    }

    public String getBindingStorageFile() {
        return bindingStorageFile;
    }

    public void setBindingStorageFile(String bindingStorageFile) {
        this.bindingStorageFile = bindingStorageFile;
    }
    ...
    public void setGeyserEnabled(boolean geyserEnabled) {
        this.geyserEnabled = geyserEnabled;
    }
    ...
    public void setGeyserPrefix(String geyserPrefix) {
        this.geyserPrefix = geyserPrefix;
    }

    public boolean isGeyserUsePrefix() {
        return geyserUsePrefix;
    }

    public void setGeyserUsePrefix(boolean geyserUsePrefix) {
        this.geyserUsePrefix = geyserUsePrefix;
    }
}
