 ...
 * NeoForge 平台服务器信息实现
 */
public class NeoForgeServer implements CommonServer {

    private final MinecraftServer server;
    private final NeoForgeTpsTracker tpsTracker;
    private final long startTime;

    public NeoForgeServer(MinecraftServer server, NeoForgeTpsTracker tpsTracker) {
        this.server = server;
    ...
    public double[] getTps() {
        // NeoForge 无 Bukkit getTPS()，由 NeoForgeTpsTracker 基于 ServerTickEvent.Post 自统计
